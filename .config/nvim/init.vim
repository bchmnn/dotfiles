...
set tabstop=8                   " number of columns occupied by tab
...
set nobackup                    " coc: Some (language) servers have issues with 
set nowritebackup               "      backup files
set cmdheight=2                 " coc: Give more space for displaying messages
set updatetime=300              " coc: Default is 4 s -> poor user experience
set shortmess+=c                " coc: Don't pass messages to |ins-completion-menu|

" coc: allow signcolumn, would shift text with each diagnostics
